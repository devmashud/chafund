  ...
  return (
    <div className="min-h-[calc(100vh-124px)] bg-gray-950 flex flex-col items-center justify-center   text-white">
      ...
      <p className="text-gray-400 text-center max-w-md mb-10">
        Sign in with your preferred method and start receiving support from your
        fans instantly.
      </p>
      ...
      <div className="social-login-buttons flex flex-col md:flex-row flex-wrap items-center justify-center gap-6 w-full max-w-lg">
        {/* Email */}
        <button className="flex items-center justify-center gap-3 px-6 py-3 rounded-2xl bg-white text-black font-medium hover:opacity-90 transition w-full md:w-auto">
          <svg
        ...
        {/* Facebook */}
        <button className="flex items-center justify-center gap-3 px-6 py-3 rounded-2xl bg-[#1A77F2] text-white font-medium hover:opacity-90 transition w-full md:w-auto">
          <svg
